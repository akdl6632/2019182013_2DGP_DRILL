...
class WalkingState:
    ...
    def do(boy):
        ...
        # 캐릭터가 월드를 벗어니자 못하도록 조정
        boy.x = clamp(0 + 50, boy.x, server.background.w - 1 - 50)
        boy.y = clamp(0 + 50, boy.y, server.background.h - 1 - 50)
    ...
    def draw(boy):
        ...
        global ball_count
        boy.font.draw(sx - 15, sy + 60, '(%d)' % (ball_count), (255, 255, 0))
